 ...
 *     Solo crear vendedor / hardcoded
 * */

function formularioOrgParteAsesor(isNew, data, readOnly, isOnModalWindow, cb)
{
					...
					items:[
							{
								...
								queryParam: 's[nombre]',
								store: orgParteStore,
								hiddenName: 'org_parte_id_buscar_asesor'
							},
							{
								xtype: 'hidden',
			       				...
			       				items:[
										{
							    			...
							    			handler: function(b,e)
							    			{
								       			...
								       			if(basicForm.isValid())
								       			{
													...
													var parteId = valores.org_parte_id_buscar_asesor;
											
													delete valores.org_parte_id_buscar_asesor;
